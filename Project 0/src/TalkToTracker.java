...
// 1) Finish Peer Class
// 2) Try to get a successful thread with one peer seeding from us, while we
// download
// 3) After that is successful, try to get one peer downloading, seed for
// someone else, incorporate
...
// A) We obviously thread between three key things, seed, download, and talk to
// tracker
// B) But how do we handle the child threads of each of these three things?
// C) The main question becomes, do we thread by piece? or do we thread by each
// peer?
