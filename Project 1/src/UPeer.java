...
public class UPeer extends RUBTClient implements Runnable
{
        ...
        // I will only use the input streams for now to test whether we can get a handshake message
    ...
    public boolean ReceiveHandshake(byte[] infoHash) throws Exception 
    {
    	       ...
    	       // This is just to verify that the handshake does not come through in simultaneous fashion
    	       // with the foreign client attempting to set up a socket. 
    	       // If this doesn't work it might be worth testing if there is anything in the streams. 
    }
    public void run() 
    {
        try 
