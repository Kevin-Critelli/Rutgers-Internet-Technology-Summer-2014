...
public class DPeer extends RUBTClient implements Runnable{
	...
	/**
	 * This function sends a handshake to the peer at ip and port passed to constructor
	 * 
	 * @author Kevin Critelli
	...
	/**
	 * This function downloads all available pieces that the peer has that we do not have
	 * it starts requesting pieces from 0 up to however many pieces there are total
	 * 
	 * @author Kevin Critelli
	 * @throws Exception
	 * */
	 ...
	 * 
	 * @author Kevin Critelli
	 * @param index int representing the index of the piece we just downloaded and are about
	 * 					to write into our main piece array
	 * */
	...
	/**
	 * Run function for this thread, send a handshake, than request pieces from the peer
	 * 
	 * @author Kevin Critelli
	 * */
