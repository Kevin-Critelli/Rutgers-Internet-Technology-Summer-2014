...
/**
 * This class contains three labels and displays information from a torrentinfo
 * object, which is generatad from a torrent info file.
 * 
 * @author pauljones
 * 
 */
public class TorrentInfoView extends JPanel {
	...
	public TorrentInfoView(TorrentInfo info) {
		...
		pieceLengthLabel.setText("Piece length: " + info.piece_length
				+ " bytes");
