...
/**
 * This class represents a server, that waits for peers to contact us for
 * uploads
 * 
...
public class FrontDoor implements Runnable {
	 ...
	 * than spawns threads (upload peer object) to handle the connection with
	 * that specific peer
	 * 
	 * @throws Exception
	...
	/**
	 * Run method for this thread, listen for handshakes, and spawn threads to
