...
public class TrackerResponse {
	...
	public TrackerResponse(TorrentInfo torrentInfo) {
		...
		if (response
				.containsKey(RUBTClientConstants.TRACKER_RESPONSE_KEY_FAILURE)) {
			// throw new Exception("Tracker failed");
		}

		if (response
				.containsKey(RUBTClientConstants.TRACKER_RESPONSE_KEY_INTERVAL))
			this.interval = (Integer) response
					.get(RUBTClientConstants.TRACKER_RESPONSE_KEY_INTERVAL);
		else {
		...
		if (response
				.containsKey(RUBTClientConstants.TRACKER_RESPONSE_KEY_COMPLETE))
			this.complete = (Integer) response
		...
		if (response
				.containsKey(RUBTClientConstants.TRACKER_RESPONSE_KEY_INCOMPLETE))
			this.incomplete = (Integer) response
		...
		if (response
				.containsKey(RUBTClientConstants.TRACKER_RESPONSE_KEY_MIN_INTERVAL))
			this.minimumInterval = (Integer) response
	...
	private byte[] getTrackerResponseWithEventStarted(TorrentInfo ti)
		...
		newURL += "?" + RUBTClientConstants.TRACKER_RESPONSE_KEY_INFO_HASH
				...
				+ RUBTClientConstants.TRACKER_RESPONSE_KEY_STARTED;
	...
	public TrackerResponse getTrackerResponse(String base_url,
		...
		if (response
				.containsKey(RUBTClientConstants.TRACKER_RESPONSE_KEY_INTERVAL))
			returnResponse.interval = (Integer) response
					.get(RUBTClientConstants.TRACKER_RESPONSE_KEY_INTERVAL);
		else {
			System.out.println("Warning: no interval, setting to zero");
